...
var CL_frida_runtime_get_type = CL_Dll.NewProc("frida_runtime_get_type")
...
func frida_device_manager_close(_self *FridaDeviceManager, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_manager_close.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))

}

func frida_device_manager_close_finish(_self *FridaDeviceManager, _result *GAsyncResult, _error **GError) {
	CL_frida_device_manager_close_finish.Call(CObjPtr(_self), CObjPtr(_result), uintptr(unsafe.Pointer(_error)))

}

func frida_device_manager_close_sync(_self *FridaDeviceManager, _cancellable *GCancellable, _error **GError) {
	CL_frida_device_manager_close_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
...
func frida_device_manager_enumerate_devices(_self *FridaDeviceManager, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_manager_enumerate_devices.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_manager_enumerate_devices_sync(_self *FridaDeviceManager, _cancellable *GCancellable, _error **GError) *FridaDeviceList {
	r, _, _ := CL_frida_device_manager_enumerate_devices_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return FridaDeviceListFormPtr(r)
}

func frida_device_manager_add_remote_device(_self *FridaDeviceManager, _host string, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_manager_add_remote_device.Call(CObjPtr(_self), uintptr(unsafe.Pointer(syscall.StringBytePtr(_host))), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_manager_add_remote_device_sync(_self *FridaDeviceManager, _host string, _cancellable *GCancellable, _error **GError) *FridaDevice {
	r, _, _ := CL_frida_device_manager_add_remote_device_sync.Call(CObjPtr(_self), uintptr(unsafe.Pointer(syscall.StringBytePtr(_host))), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return FridaDeviceFormPtr(r)
}

func frida_device_manager_remove_remote_device(_self *FridaDeviceManager, _host string, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_manager_remove_remote_device.Call(CObjPtr(_self), uintptr(unsafe.Pointer(syscall.StringBytePtr(_host))), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_manager_remove_remote_device_sync(_self *FridaDeviceManager, _host string, _cancellable *GCancellable, _error **GError) {
	CL_frida_device_manager_remove_remote_device_sync.Call(CObjPtr(_self), uintptr(unsafe.Pointer(syscall.StringBytePtr(_host))), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
...
func frida_device_get_frontmost_application(_self *FridaDevice, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_get_frontmost_application.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_get_frontmost_application_sync(_self *FridaDevice, _cancellable *GCancellable, _error **GError) *FridaApplication {
	r, _, _ := CL_frida_device_get_frontmost_application_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return FridaApplicationFormPtr(r)
}

func frida_device_enumerate_applications(_self *FridaDevice, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_enumerate_applications.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_enumerate_applications_sync(_self *FridaDevice, _cancellable *GCancellable, _error **GError) *FridaApplicationList {
	r, _, _ := CL_frida_device_enumerate_applications_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return FridaApplicationListFormPtr(r)
}

func frida_device_get_process_by_pid(_self *FridaDevice, _pid int, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_get_process_by_pid.Call(CObjPtr(_self), uintptr(C.int(_pid)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_get_process_by_pid_sync(_self *FridaDevice, _pid int, _cancellable *GCancellable, _error **GError) *FridaProcess {
	r, _, _ := CL_frida_device_get_process_by_pid_sync.Call(CObjPtr(_self), uintptr(C.int(_pid)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return FridaProcessFormPtr(r)
}
...
func frida_device_find_process_by_pid(_self *FridaDevice, _pid int, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_find_process_by_pid.Call(CObjPtr(_self), uintptr(C.int(_pid)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_find_process_by_pid_sync(_self *FridaDevice, _pid int, _cancellable *GCancellable, _error **GError) *FridaProcess {
	r, _, _ := CL_frida_device_find_process_by_pid_sync.Call(CObjPtr(_self), uintptr(C.int(_pid)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return FridaProcessFormPtr(r)
}
...
func frida_device_enumerate_processes(_self *FridaDevice, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_enumerate_processes.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_enumerate_processes_sync(_self *FridaDevice, _cancellable *GCancellable, _error **GError) *FridaProcessList {
	r, _, _ := CL_frida_device_enumerate_processes_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return FridaProcessListFormPtr(r)
}

func frida_device_enable_spawn_gating(_self *FridaDevice, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_enable_spawn_gating.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_enable_spawn_gating_sync(_self *FridaDevice, _cancellable *GCancellable, _error **GError) {
	CL_frida_device_enable_spawn_gating_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))

}

func frida_device_disable_spawn_gating(_self *FridaDevice, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_disable_spawn_gating.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_disable_spawn_gating_sync(_self *FridaDevice, _cancellable *GCancellable, _error **GError) {
	CL_frida_device_disable_spawn_gating_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))

}

func frida_device_enumerate_pending_spawn(_self *FridaDevice, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_enumerate_pending_spawn.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_enumerate_pending_spawn_sync(_self *FridaDevice, _cancellable *GCancellable, _error **GError) *FridaSpawnList {
	r, _, _ := CL_frida_device_enumerate_pending_spawn_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return FridaSpawnListFormPtr(r)
}

func frida_device_enumerate_pending_children(_self *FridaDevice, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_enumerate_pending_children.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_enumerate_pending_children_sync(_self *FridaDevice, _cancellable *GCancellable, _error **GError) *FridaChildList {
	r, _, _ := CL_frida_device_enumerate_pending_children_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return FridaChildListFormPtr(r)
}

func frida_device_spawn(_self *FridaDevice, _program string, _options *FridaSpawnOptions, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_spawn.Call(CObjPtr(_self), uintptr(unsafe.Pointer(syscall.StringBytePtr(_program))), CObjPtr(_options), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_spawn_sync(_self *FridaDevice, _program string, _options *FridaSpawnOptions, _cancellable *GCancellable, _error **GError) int {
	r, _, _ := CL_frida_device_spawn_sync.Call(CObjPtr(_self), uintptr(unsafe.Pointer(syscall.StringBytePtr(_program))), CObjPtr(_options), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return int(r)
}

func frida_device_input(_self *FridaDevice, _pid int, _data uintptr, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_input.Call(CObjPtr(_self), uintptr(C.int(_pid)), uintptr(int(_data)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_input_sync(_self *FridaDevice, _pid int, _data uintptr, _cancellable *GCancellable, _error **GError) {
	CL_frida_device_input_sync.Call(CObjPtr(_self), uintptr(C.int(_pid)), uintptr(int(_data)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))

}

func frida_device_resume(_self *FridaDevice, _pid int, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_resume.Call(CObjPtr(_self), uintptr(C.int(_pid)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_resume_sync(_self *FridaDevice, _pid int, _cancellable *GCancellable, _error **GError) {
	CL_frida_device_resume_sync.Call(CObjPtr(_self), uintptr(C.int(_pid)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))

}

func frida_device_kill(_self *FridaDevice, _pid int, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_kill.Call(CObjPtr(_self), uintptr(C.int(_pid)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_kill_sync(_self *FridaDevice, _pid int, _cancellable *GCancellable, _error **GError) {
	CL_frida_device_kill_sync.Call(CObjPtr(_self), uintptr(C.int(_pid)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))

}

func frida_device_attach(_self *FridaDevice, _pid int, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_attach.Call(CObjPtr(_self), uintptr(C.int(_pid)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_attach_sync(_self *FridaDevice, _pid int, _cancellable *GCancellable, _error **GError) *FridaSession {
	r, _, _ := CL_frida_device_attach_sync.Call(CObjPtr(_self), uintptr(C.int(_pid)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return FridaSessionFormPtr(r)
}

func frida_device_inject_library_file(_self *FridaDevice, _pid int, _path string, _entrypoint string, _data string, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_inject_library_file.Call(CObjPtr(_self), uintptr(C.int(_pid)), uintptr(unsafe.Pointer(syscall.StringBytePtr(_path))), uintptr(unsafe.Pointer(syscall.StringBytePtr(_entrypoint))), uintptr(unsafe.Pointer(syscall.StringBytePtr(_data))), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_inject_library_file_sync(_self *FridaDevice, _pid int, _path string, _entrypoint string, _data string, _cancellable *GCancellable, _error **GError) int {
	r, _, _ := CL_frida_device_inject_library_file_sync.Call(CObjPtr(_self), uintptr(C.int(_pid)), uintptr(unsafe.Pointer(syscall.StringBytePtr(_path))), uintptr(unsafe.Pointer(syscall.StringBytePtr(_entrypoint))), uintptr(unsafe.Pointer(syscall.StringBytePtr(_data))), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return int(r)
}

func frida_device_inject_library_blob(_self *FridaDevice, _pid int, _blob uintptr, _entrypoint string, _data string, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_device_inject_library_blob.Call(CObjPtr(_self), uintptr(C.int(_pid)), uintptr(int(_blob)), uintptr(unsafe.Pointer(syscall.StringBytePtr(_entrypoint))), uintptr(unsafe.Pointer(syscall.StringBytePtr(_data))), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_device_inject_library_blob_sync(_self *FridaDevice, _pid int, _blob uintptr, _entrypoint string, _data string, _cancellable *GCancellable, _error **GError) int {
	r, _, _ := CL_frida_device_inject_library_blob_sync.Call(CObjPtr(_self), uintptr(C.int(_pid)), uintptr(int(_blob)), uintptr(unsafe.Pointer(syscall.StringBytePtr(_entrypoint))), uintptr(unsafe.Pointer(syscall.StringBytePtr(_data))), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return int(r)
}
...
func frida_session_detach(_self *FridaSession, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_session_detach.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))

}

func frida_session_detach_finish(_self *FridaSession, _result *GAsyncResult, _error **GError) {
	CL_frida_session_detach_finish.Call(CObjPtr(_self), CObjPtr(_result), uintptr(unsafe.Pointer(_error)))

}

func frida_session_detach_sync(_self *FridaSession, _cancellable *GCancellable, _error **GError) {
	CL_frida_session_detach_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))

}

func frida_session_enable_child_gating(_self *FridaSession, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_session_enable_child_gating.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_session_enable_child_gating_sync(_self *FridaSession, _cancellable *GCancellable, _error **GError) {
	CL_frida_session_enable_child_gating_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))

}

func frida_session_disable_child_gating(_self *FridaSession, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_session_disable_child_gating.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_session_disable_child_gating_sync(_self *FridaSession, _cancellable *GCancellable, _error **GError) {
	CL_frida_session_disable_child_gating_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))

}

func frida_session_create_script(_self *FridaSession, _source string, _options *FridaScriptOptions, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_session_create_script.Call(CObjPtr(_self), uintptr(unsafe.Pointer(syscall.StringBytePtr(_source))), CObjPtr(_options), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_session_create_script_sync(_self *FridaSession, _source string, _options *FridaScriptOptions, _cancellable *GCancellable, _error **GError) *FridaScript {
	r, _, _ := CL_frida_session_create_script_sync.Call(CObjPtr(_self), uintptr(unsafe.Pointer(syscall.StringBytePtr(_source))), CObjPtr(_options), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return FridaScriptFormPtr(r)
}

func frida_session_create_script_from_bytes(_self *FridaSession, _bytes uintptr, _options *FridaScriptOptions, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_session_create_script_from_bytes.Call(CObjPtr(_self), uintptr(int(_bytes)), CObjPtr(_options), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_session_create_script_from_bytes_sync(_self *FridaSession, _bytes uintptr, _options *FridaScriptOptions, _cancellable *GCancellable, _error **GError) *FridaScript {
	r, _, _ := CL_frida_session_create_script_from_bytes_sync.Call(CObjPtr(_self), uintptr(int(_bytes)), CObjPtr(_options), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return FridaScriptFormPtr(r)
}

func frida_session_compile_script(_self *FridaSession, _source string, _options *FridaScriptOptions, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_session_compile_script.Call(CObjPtr(_self), uintptr(unsafe.Pointer(syscall.StringBytePtr(_source))), CObjPtr(_options), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_session_compile_script_sync(_self *FridaSession, _source string, _options *FridaScriptOptions, _cancellable *GCancellable, _error **GError) uintptr {
	r, _, _ := CL_frida_session_compile_script_sync.Call(CObjPtr(_self), uintptr(unsafe.Pointer(syscall.StringBytePtr(_source))), CObjPtr(_options), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return uintptr(r)
}

func frida_session_enable_debugger(_self *FridaSession, _port int, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_session_enable_debugger.Call(CObjPtr(_self), uintptr(C.int(_port)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_session_enable_debugger_sync(_self *FridaSession, _port int, _cancellable *GCancellable, _error **GError) {
	CL_frida_session_enable_debugger_sync.Call(CObjPtr(_self), uintptr(C.int(_port)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))

}

func frida_session_disable_debugger(_self *FridaSession, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_session_disable_debugger.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_session_disable_debugger_sync(_self *FridaSession, _cancellable *GCancellable, _error **GError) {
	CL_frida_session_disable_debugger_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))

}

func frida_session_enable_jit(_self *FridaSession, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_session_enable_jit.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_session_enable_jit_sync(_self *FridaSession, _cancellable *GCancellable, _error **GError) {
	CL_frida_session_enable_jit_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
...
func frida_script_load(_self *FridaScript, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_script_load.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_script_load_sync(_self *FridaScript, _cancellable *GCancellable, _error **GError) {
	CL_frida_script_load_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))

}

func frida_script_unload(_self *FridaScript, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_script_unload.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_script_unload_sync(_self *FridaScript, _cancellable *GCancellable, _error **GError) {
	CL_frida_script_unload_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))

}

func frida_script_eternalize(_self *FridaScript, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_script_eternalize.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_script_eternalize_sync(_self *FridaScript, _cancellable *GCancellable, _error **GError) {
	CL_frida_script_eternalize_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))

}

func frida_script_post(_self *FridaScript, _message string, _data uintptr, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_script_post.Call(CObjPtr(_self), uintptr(unsafe.Pointer(syscall.StringBytePtr(_message))), uintptr(int(_data)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_script_post_sync(_self *FridaScript, _message string, _data uintptr, _cancellable *GCancellable, _error **GError) {
	CL_frida_script_post_sync.Call(CObjPtr(_self), uintptr(unsafe.Pointer(syscall.StringBytePtr(_message))), uintptr(int(_data)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
...
func frida_injector_close(_self *FridaInjector, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_injector_close.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))

}

func frida_injector_close_finish(_self *FridaInjector, _result *GAsyncResult, _error **GError) {
	CL_frida_injector_close_finish.Call(CObjPtr(_self), CObjPtr(_result), uintptr(unsafe.Pointer(_error)))

}

func frida_injector_close_sync(_self *FridaInjector, _cancellable *GCancellable, _error **GError) {
	CL_frida_injector_close_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))

}

func frida_injector_inject_library_file(_self *FridaInjector, _pid int, _path string, _entrypoint string, _data string, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_injector_inject_library_file.Call(CObjPtr(_self), uintptr(C.int(_pid)), uintptr(unsafe.Pointer(syscall.StringBytePtr(_path))), uintptr(unsafe.Pointer(syscall.StringBytePtr(_entrypoint))), uintptr(unsafe.Pointer(syscall.StringBytePtr(_data))), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_injector_inject_library_file_sync(_self *FridaInjector, _pid int, _path string, _entrypoint string, _data string, _cancellable *GCancellable, _error **GError) int {
	r, _, _ := CL_frida_injector_inject_library_file_sync.Call(CObjPtr(_self), uintptr(C.int(_pid)), uintptr(unsafe.Pointer(syscall.StringBytePtr(_path))), uintptr(unsafe.Pointer(syscall.StringBytePtr(_entrypoint))), uintptr(unsafe.Pointer(syscall.StringBytePtr(_data))), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return int(r)
}

func frida_injector_inject_library_blob(_self *FridaInjector, _pid int, _blob uintptr, _entrypoint string, _data string, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_injector_inject_library_blob.Call(CObjPtr(_self), uintptr(C.int(_pid)), uintptr(int(_blob)), uintptr(unsafe.Pointer(syscall.StringBytePtr(_entrypoint))), uintptr(unsafe.Pointer(syscall.StringBytePtr(_data))), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_injector_inject_library_blob_sync(_self *FridaInjector, _pid int, _blob uintptr, _entrypoint string, _data string, _cancellable *GCancellable, _error **GError) int {
	r, _, _ := CL_frida_injector_inject_library_blob_sync.Call(CObjPtr(_self), uintptr(C.int(_pid)), uintptr(int(_blob)), uintptr(unsafe.Pointer(syscall.StringBytePtr(_entrypoint))), uintptr(unsafe.Pointer(syscall.StringBytePtr(_data))), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return int(r)
}

func frida_injector_demonitor_and_clone_state(_self *FridaInjector, _id int, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_injector_demonitor_and_clone_state.Call(CObjPtr(_self), uintptr(C.int(_id)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_injector_demonitor_and_clone_state_sync(_self *FridaInjector, _id int, _cancellable *GCancellable, _error **GError) int {
	r, _, _ := CL_frida_injector_demonitor_and_clone_state_sync.Call(CObjPtr(_self), uintptr(C.int(_id)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
	return int(r)
}

func frida_injector_recreate_thread(_self *FridaInjector, _pid int, _id int, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_injector_recreate_thread.Call(CObjPtr(_self), uintptr(C.int(_pid)), uintptr(C.int(_id)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_injector_recreate_thread_sync(_self *FridaInjector, _pid int, _id int, _cancellable *GCancellable, _error **GError) {
	CL_frida_injector_recreate_thread_sync.Call(CObjPtr(_self), uintptr(C.int(_pid)), uintptr(C.int(_id)), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
...
func frida_file_monitor_disable(_self *FridaFileMonitor, _cancellable *GCancellable, _callback GAsyncReadyCallback, _user_data uintptr) {
	CL_frida_file_monitor_disable.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_callback)), uintptr(int(_user_data)))
...
func frida_file_monitor_disable_sync(_self *FridaFileMonitor, _cancellable *GCancellable, _error **GError) {
	CL_frida_file_monitor_disable_sync.Call(CObjPtr(_self), CObjPtr(_cancellable), uintptr(unsafe.Pointer(_error)))
...
func frida_runtime_get_type() GType {
	r, _, _ := CL_frida_runtime_get_type.Call()
	return GType(r)
}
