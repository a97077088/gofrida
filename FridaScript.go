...
func (this *FridaScript) RpcCall(_fname string, args []interface{}) (interface{}, error) {
	...
	var gerr *GError
	frida_script_post_sync(this, string(bt), 0, nil, &gerr)
	if gerr != nil {
...
func (this *FridaScript) Post(_message map[string]interface{}, _data uintptr) error {
	...
	frida_script_post_sync(this, string(bt), _data, nil, &gerr)
	if gerr != nil {
...
func (this *FridaScript) UnLoad() error {
	var gerr *GError
	frida_script_unload_sync(this, nil, &gerr)
	if gerr != nil {
		return errors.New(gerr.Message())
	}
...
func (this *FridaScript) Load() error {
	var gerr *GError
	frida_script_load_sync(this, nil, &gerr)
	if gerr != nil {
		return errors.New(gerr.Message())
	}
	return nil
